	...
	<div class="relative text-center">
		...
		{#if slice.primary.image}
			<div class="hero__image glass-container mt-16 w-fit opacity-0">
				<div
					class="hero__glow hero__glow-one absolute left-1/3 top-0 -z-10 mt-16 h-2/3 w-2/3 bg-violet-700/50 mix-blend-screen blur-[120px] filter"
				></div>
				<div
					class="hero__glow hero__glow-two absolute left-0 top-1/3 -z-10 mt-16 h-2/3 w-2/3 bg-orange-600/50 mix-blend-screen blur-[120px] filter"
				></div>
